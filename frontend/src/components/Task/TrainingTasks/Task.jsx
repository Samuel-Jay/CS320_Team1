...
function Task(task){
    ...
    return (
        ...
        <div className="EmailRow_time">
            Start date: {task.task.startDate.split("T")[0].split("-")[1]+"/"+task.task.startDate.split("T")[0].split("-")[2]+"/"+task.task.startDate.split("T")[0].split("-")[0]},    Due date: {task.task.dueDate.split("T")[0].split("-")[1]+"/"+task.task.dueDate.split("T")[0].split("-")[2]+"/"+task.task.dueDate.split("T")[0].split("-")[0]}
        </div>
        <div className="EmailRow_time">
